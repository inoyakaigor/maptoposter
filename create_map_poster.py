...
def create_poster(city, country, point, dist, output_file, output_format, truncate_by_edge):
...
Examples:
  ...
  python create_map_poster.py --list-themes
    ...
    try:
        ...
        create_poster(args.city, args.country, coords, args.distance, output_file, args.format, args.truncate_by_edge)
